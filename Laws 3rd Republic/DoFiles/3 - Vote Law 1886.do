...
//Import data
use "Laws 3rd Republic/RawData/VoteLoi1886.dta"

//Harmonize names
ren Département departement
replace departement="Pyrénées-Orientales" if departement=="Pyrénées Orientales"
replace departement="Haute-Saône" if departement=="Haute-Saône "
replace departement="Lozère" if departement=="Lorèze"
